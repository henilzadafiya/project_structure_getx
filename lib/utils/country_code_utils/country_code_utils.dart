...
import 'package:project_structure/widget/country_code_picker_view/country_picker_view.dart';
import 'package:project_structure/widget/popups_and_dialogs/bottom_sheet_view.dart';

class CountryCodeUtils {
  static void openCountryCodePicker({
    required BuildContext context,
    required Function(CountryCodeModel) onSelect,
    bool selectionEnabled=true
  }) {
    if(selectionEnabled) {
      commonBottomSheetNew(
        context,
        title: S.of(context).searchYourCountry,
  ...
  static CountryCodeModel getCountryCodeModelByCode(String dialCode) {
    return countryCodeList.firstWhereOrNull((element) => element.dialCode == dialCode) ??
  ...
  static const List<CountryCodeModel> countryCodeList = [
    CountryCodeModel(
      name: "Afghanistan",
      nameTranslations: {
        "sk": "Afganistan",
