...
class AppPreference {
  ...
  static const String _showOnBord = 'showOnBord';
  ...
  static Future setOnBoarding(bool value) async {
    await _prefs.setBool(_showOnBord, value);
  }

  static bool? getOnBoarding() {
    return _prefs.getBool(_showOnBord);
  }

  static String getUsedThemeName() {
    final String? value = _prefs.getString(_themeKey);
    // return value == UsedTheme.lightTheme.name ? UsedTheme.lightTheme : UsedTheme.darkTheme;
    if(value == null){
